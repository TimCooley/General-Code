...
4062476, 4062571, 4062572, 4062751, 4062752, 4062769, 4062780, 4062788, 4062795, 4062808, 4062809, 4062812, 4062866, 4062889, 4062917, 4062919, 4062965, 4062975, 4062983, 4062997
    ...
    BEGIN
      ...
      '31-AUG-2012' --************************************************** ENTER MERGER DATE HERE
...
DBMS_OUTPUT.PUT_LINE('---');
  ...
  IF difference_value >= 0 THEN 
    ...
    trans_type := 'FRT_BUY_TO_BALANCE_CLAIM';
  ELSE
    frt_transaction_type := 'S';
    trans_type := 'FRT_SELL_TO_BALANCE_CLAIM';
  END IF;
...
AND PRE.CLIENT_ID IN (SELECT CLIENT_ID FROM FRT.CLIENT WHERE SHORT_NAME IN ( 
 ...
 'BLACKROCK'--, 'BROWNBROS3', 'CALSTRS', 'CHARFIRE', 'KEYBANK1', 'KIC', 'LGSUPER', 'NCTREASURY', 'PHILLY', 'REGIONS', 'RESTSUPER', 'SBAFLA', 'SCERS2', 'SEICANADA', 'SEIINVESTMENT', 'SEIUCITS', 'UCREGENTS', 'UNIONBANK', 'UNIONBANKTRUST', 'WEISS', 'WESTVIRGINIA', 'WTCPOOL'
